...
function App() {
	...
	return (
		<>
			<Header />
			<main>
				<PresentBox name="Pix" imgURL={pix01} whereToFind="no seu app do banco" details="O amigo secreto é de 50 reais, mas lembre-se que o céu é o limite" images={presentPix} />
				<PresentBox name="Chuteira de Futsal" imgURL={chuteira02} whereToFind="Tanto online quanto em loja fisica, como a umbro e a nike" details="Eu calço 39-40" images={presentChuteira} />
				...
				<PresentBox name="Camisa de Programação" imgURL={camisaProgramador} whereToFind="loja online" details="se não conseguir achar o da imagem tudo bem, mas eu quero uma preta, porque a minha branca suja muito facil, se tiver while (alive) ou while (!dead) na camisa, não pode ter repeat" images={presentCamisaProgramador} />
				...
				<PresentBox name="USB de qualidade" imgURL={usbHub} whereToFind="loja online tipo mercado livre e a amazon" details="USB hub barato é ruim e dura menos de um mês, então não compre os de 15 reais porque só vão durar 15 dias" images={presentUsbHub} />
